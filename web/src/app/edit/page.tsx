...
import { ArrowLeft, ChevronRight, UtensilsCrossed, Carrot } from "lucide-react";
  ...
  return (
    <main className="flex flex-col w-full min-h-screen bg-gray-50/50">
      ...
      <div className="flex-1 p-6 max-w-3xl mx-auto w-full space-y-8">
        ...
        {/* 菜品管理 Section */}
        <section>
            <h2 className="text-sm font-bold uppercase tracking-wider text-gray-400 mb-4 pl-1">菜品管理</h2>
            ...
            {Object.keys(dishes).map((category) => (
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                    <h3 className="font-bold text-lg text-gray-800 group-hover:text-primary transition-colors">{category}</h3>
                    <p className="text-sm text-gray-500">
                        {dishes[category]?.length || 0} 道菜
                    </p>
                    </div>
                </div>
        ...
        {/* 食材管理 Section */}
        <section>
            <h2 className="text-sm font-bold uppercase tracking-wider text-gray-400 mb-4 pl-1">资源库</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Link 
                href="/ingredients"
