...
import { ArrowLeft, ChevronRight, Carrot, UtensilsCrossed, Tag } from "lucide-react";
import { useMenuStore } from "@/store/menuStore";
import { Button } from "@/components/ui/button";

export default function EditMenuPage() {
  const { dishes, ingredients, tags } = useMenuStore();
      ...
      <div className="flex-1 p-6 max-w-3xl mx-auto w-full space-y-8">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link 
              href="/edit/tags"
              className="group flex items-center justify-between p-6 bg-white rounded-xl border shadow-sm hover:shadow-md transition-all hover:border-blue-500/20 active:scale-99"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg text-gray-800 group-hover:text-blue-600 transition-colors">标签管理</h3>
